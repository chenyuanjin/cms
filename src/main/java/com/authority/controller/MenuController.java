...
public class MenuController {
    ...
    public String view(@PathVariable("view")String view){
        if(StringUtil.isNotEmpty(view)){
            ...
            }else if("resources".equals(view)){
                return "core/menu/menu_resources_select";
            }
        }
    ...
    public @ResponseBody
    MessageBox edit(SysMenus menus){
        MessageBox messageBox = new MessageBox();
    ...
    public @ResponseBody
    MessageBox delete(String menuid){
        MessageBox messageBox = new MessageBox();
