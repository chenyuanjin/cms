...
//            }
    ...
    public @ResponseBody
    MessageBox getAhtorityList(Pager pager)
    {
    ...
    public @ResponseBody
    MessageBox addAuthority(SysAuthorities authorities){
        MessageBox messageBox = new MessageBox();
        if(authorities != null){
    ...
    public @ResponseBody
    MessageBox checkAuthorityRoleSize(String authId){
        MessageBox messageBox = new MessageBox();
    ...
    public  @ResponseBody
    MessageBox delAuthority(String authorityId){
        MessageBox messageBox = new MessageBox();
    ...
    public @ResponseBody
    MessageBox getAuthorityRes(Pager pager,
    ...
    public @ResponseBody
    MessageBox delAuthorityRes(String resIds,
                               String authorityId){
        MessageBox messageBox = new MessageBox();
