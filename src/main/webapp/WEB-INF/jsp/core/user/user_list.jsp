    ...
    <div region="center" border="false">
        <table id="user_datagrid" class="easyui-datagrid" title="系统用户列表"
            ...
            <tr fit="true">
                ...
                <th data-options="field:'userName',width:0.15,sortable:true">用户姓名</th>
                <th data-options="field:'userAccount',width:0.15,sortable:true">登陆帐号</th>
                ...
                <th data-options="field:'userType',width:0.1,formatter:userTypeReader,sortable:true">用户类型</th>
                <th data-options="field:'accountNonLocked',width:0.1,sortable:true,formatter:isUserLocked">是否锁定</th>
                <th data-options="field:'creator',width:0.05,sortable:true">创建者</th>
                <th data-options="field:'job',width:0.05,sortable:true">职务</th>
               <%-- <th data-options="field:'accountNonLocked',width:0.1,sortable:false,formatter:isUserLocked">是否锁定</th>--%>
