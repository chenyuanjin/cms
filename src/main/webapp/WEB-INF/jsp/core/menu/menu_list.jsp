...
<%--选择资源--%>
<div id="sys_menu_resoucse_select_dialog" class="easyui-dialog" title="系统资源" data-options="width:800,height:600,href:'admin/menu/resources',method:'get',buttons:[{text:'选择',handler:selectedMenuResources}],closed:true">

</div>
<%--选择资源--%>
<div id="sys_menu_resoucse_edit_select_dialog" class="easyui-dialog" title="系统资源" data-options="width:800,height:600,href:'admin/menu/resources',method:'get',buttons:[{text:'选择',handler:editSelectedMenuResources}],closed:true">
