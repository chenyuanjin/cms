...
<table id="res_group_datagrid" class="easyui-treegrid"
       data-options="iconCls:'icon-res',
       treeField: 'resourceName',
       idField: 'id',
       toolbar:'#sys_resman_tools',
       striped:true,
       url:'admin/resouces/list',
       method:'POST',
       rownumbers:true,
       border:false,
       singleSelect:true"
    ...
    <tr fit="true">
        ...
        <th data-options="field:'id',width:0.25">序号</th>
        <th data-options="field:'resourcePath',width:0.3">资源路径</th>
        <th data-options="field:'resourceDesc',width:0.25">资源描述</th>
    </tr>
    </thead>
...
<div id="sys_resman_tools" style="text-align: right;">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-find',plain:true,resizable:true"
       onclick="sys_res_find();">查找</a>
    <security:authorize ifAllGranted="AUTH_RESOUCES_ADD">
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true,resizable:true"
           onclick="addRes();">添加</a>
    </security:authorize>
    ...
    <security:authorize ifAllGranted="AUTH_RESOUCES_DELETE">
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-edit',plain:true,resizable:true,modal:true"
